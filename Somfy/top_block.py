...
# Title: Test
# Author: Juehv
# Description: Testing CC1100 FSK
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_per_sym = samp_per_sym = 500
        self.resamp_rate = resamp_rate = 32000
        self.offset = offset = 0
        self.filter_sharpness = filter_sharpness = 10000
        self.filter_bandwidth = filter_bandwidth = 100000
        self.centre_freq = centre_freq = 868949000
        ...
        self.rtlsdr_source_0.set_center_freq(centre_freq, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/Users/kesenheimer/Documents/Basteln/SDR/gnuRadio_projects/Somfy/Somfy-868.949MHz.complex', False)
