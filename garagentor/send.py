...
class send(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.payload = payload = str("\x01\x55\x55\x54\x00\x92\x4d\x24\x92\x49\x26\xd2\x4d\x24\x9b\x6d\xb4\x9a\x49\x34\xd3\x6d\xb4\x9b\x4d\xb6\xdb\x6d\x36\xd8")
        self.padding = padding = 100*"\x00"
        self.samples_per_symbol = samples_per_symbol = 3800
        self.samp_rate = samp_rate = 10e6
        self.payload_bytes = payload_bytes = [ord(i) for i in payload]
        self.padding_bytes = padding_bytes = [ord(i) for i in padding]
        self.gain = gain = 1
        self.freq = freq = 432.88e6
        ...
        self._gain_range = Range(1, 10, 0.1, 1, 200)
