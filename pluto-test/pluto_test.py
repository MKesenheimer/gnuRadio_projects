...
class pluto_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._f0_range = Range(100e6, 2000e6, 10e6, 1023e5, 200)
        ...
        self.iio_pluto_source_0 = iio.pluto_source('usb:20.11.5', int(f0), int(samp_rate), int(1e6), 32768, True, True, True, 'manual', 74.5, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_source_0.set_params(int(self.f0), int(self.samp_rate), int(1e6), True, True, True, 'manual', 74.5, '', True)
